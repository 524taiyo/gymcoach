...
export const WorkoutIcon = ({ size = 24, ...props }: IconProps) => (
  <svg {...base(size)} {...props}>
    <path d="M8.8 12h6.4"/><rect x="5.2" y="7.2" width="3.6" height="9.6" rx="1.4"/><rect x="15.2" y="7.2" width="3.6" height="9.6" rx="1.4"/><path d="M2.8 9.6v4.8M21.2 9.6v4.8"/>
  </svg>
);

export const HistoryIcon = ({ size = 24, ...props }: IconProps) => (
  <svg {...base(size)} {...props}>
    <circle cx="12" cy="12" r="8.4"/><path d="M12 7.2V12l3.4 2"/>
  </svg>
);
...
export const SettingsIcon = ({ size = 24, ...props }: IconProps) => (
  <svg {...base(size)} {...props}>
    <path d="M4 7h8M17 7h3M4 12h3M12 12h8M4 17h8M17 17h3"/><circle cx="14.5" cy="7" r="2.1"/><circle cx="9.5" cy="12" r="2.1"/><circle cx="14.5" cy="17" r="2.1"/>
  </svg>
);
...
export const CalendarIcon = ({ size = 24, ...props }: IconProps) => (
  <svg {...base(size)} {...props}>
    <rect x="3.4" y="5.2" width="17.2" height="15.4" rx="2.6"/><path d="M8 3.2v4M16 3.2v4M3.4 10.2h17.2"/>
  </svg>
);

export const TimerIcon = ({ size = 24, ...props }: IconProps) => (
  <svg {...base(size)} {...props}>
    <circle cx="12" cy="13.6" r="7.4"/><path d="M12 9.8v3.8M9.5 2.6h5"/>
  </svg>
);

export const ProfileIcon = ({ size = 24, ...props }: IconProps) => (
  <svg {...base(size)} {...props}>
    <circle cx="12" cy="8.2" r="3.8"/><path d="M4.9 20.5c0-3.7 3.2-5.6 7.1-5.6s7.1 1.9 7.1 5.6"/>
  </svg>
);
