...
export const coach = {
  ...
  programProposal: {
    title: 'Создать эту программу',
    description:
      'План, предложенный тренером. При создании недостающие упражнения добавятся в каталог, а программа станет активной.',
    summary: '{workouts} тренировок / {exercises} упражнений',
    willReplace: 'Текущая активная программа сохранится вместе с историей, но станет неактивной.',
    create: 'Создать и активировать',
    creating: 'Создание...',
    created: 'Создано',
