...
export const coach = {
  ...
  chat: {
    ...
    plannedWorkout: 'Тренировка «{name}» прикреплена.',
    plannedWorkoutDescription:
      'Тренер видит упражнения этой тренировки, их цели и результаты прошлого раза по каждому.',
    emptyPlannedWorkout:
      'Собираетесь тренироваться? Спросите, подходит ли объём на сегодня, с какого веса начать и что заменить.',
    empty:
