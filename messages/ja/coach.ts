...
export const coach = {
  ...
  chat: {
    ...
    plannedWorkout: '「{name}」を参照中。',
    plannedWorkoutDescription:
      'コーチはこのメニューの種目・目標・各種目の直近の実績を確認できます。',
    emptyPlannedWorkout:
      'これから始めますか？今日のボリュームが適切か、開始重量、種目の入れ替えなどを相談できます。',
    empty:
  ...
  programProposal: {
    title: 'このプログラムを作成',
    description:
      'コーチが提案したプランです。作成すると、カタログに無い種目を追加したうえで、このプログラムが有効になります。',
    summary: '{workouts} セッション / {exercises} 種目',
    willReplace: '現在のアクティブなプログラムは履歴を残したまま非アクティブになります。',
    create: '作成して有効化',
    creating: '作成中...',
    created: '作成しました',
    open: 'プログラムを開く',
    error: 'プログラムを作成できませんでした。',
  },
  context: {
    title: 'コーチが見ているデータ',
