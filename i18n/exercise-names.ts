...
export const exerciseNameDictionaries: Partial<Record<Locale, ExerciseNameDictionary>> = {
  ...
  ja: {
    'Back extension (hyperextension)': 'バックエクステンション',
    'Back Squat': 'バックスクワット',
    'Barbell bench press': 'バーベルベンチプレス',
    'Barbell Curl': 'バーベルカール',
    'Barbell good morning': 'グッドモーニング',
    'Barbell hip thrust (or machine)': 'ヒップスラスト (バーベルまたはマシン)',
    'Barbell Row': 'バーベルロウ',
    'Barbell wrist curl': 'バーベルリストカール',
    'Bench Press': 'ベンチプレス',
    'Bent-over barbell row': 'ベントオーバーロウ',
    'Bulgarian split squat': 'ブルガリアンスクワット',
    'Bulgarian Split Squat': 'ブルガリアンスクワット',
    'Cable crunch (kneeling)': 'ケーブルクランチ',
    'Cable Curl': 'ケーブルカール',
    'Cable Fly': 'ケーブルフライ',
    'Cable glute kickback': 'ケーブルキックバック',
    'Cable lateral raises': 'ケーブルサイドレイズ',
    'Chest-supported machine row': 'チェストサポートロウ (マシン)',
    'Chin-up': 'チンニング (逆手)',
    'Close-grip bench press': 'ナローベンチプレス',
    ...
    'Dumbbell Row': 'ダンベルロウ',
    'EZ-bar curl': 'EZバーカール',
    'EZ-bar skull crusher': 'EZバースカルクラッシャー',
    'Face Pull': 'フェイスプル',
    'Face pull (rope)': 'フェイスプル (ロープ)',
    'Flat dumbbell bench press': 'ダンベルベンチプレス',
    'Front Squat': 'フロントスクワット',
    'Goblet squat': 'ゴブレットスクワット',
    'Hammer Curl': 'ハンマーカール',
    'Hammer curl (dumbbell)': 'ハンマーカール (ダンベル)',
    'Hanging Leg Raise': 'ハンギングレッグレイズ',
    'Hanging leg raises': 'ハンギングレッグレイズ',
    'Hip adduction machine': 'アダクションマシン',
    'Incline Bench Press': 'インクラインベンチプレス',
    'Incline dumbbell curl (bench 60 deg)': 'インクラインダンベルカール (60度)',
    'Incline Dumbbell Press': 'インクラインダンベルプレス',
    'Incline dumbbell press (30 deg)': 'インクラインダンベルプレス (30度)',
    'Jump rope': '縄跳び',
    'Lat Pulldown': 'ラットプルダウン',
    'Lat pulldown (wide grip)': 'ラットプルダウン (ワイドグリップ)',
    'Lateral Raise': 'サイドレイズ',
    'Leg Curl': 'レッグカール',
    'Leg extension': 'レッグエクステンション',
    'Leg Extension': 'レッグエクステンション',
    'Leg Press': 'レッグプレス',
    'Leg press (45 deg)': 'レッグプレス (45度)',
    'Lying leg curl': 'ライイングレッグカール',
    'Machine chest press': 'チェストプレス (マシン)',
    'Machine crunch': 'マシンクランチ',
    'Machine dips or parallel bars': 'ディップス (マシンまたは平行棒)',
    'Machine rear delt fly': 'リアデルトフライ (マシン)',
    'Machine squat (or Hack squat)': 'マシンスクワット (またはハックスクワット)',
    'Neutral-grip lat pulldown': 'ラットプルダウン (ニュートラルグリップ)',
    'Overhead cable triceps extension': 'ケーブルオーバーヘッドエクステンション',
    'Overhead Press': 'オーバーヘッドプレス',
    'Overhead Triceps Extension': 'オーバーヘッドトライセプスエクステンション',
    'Pec deck (or cable fly)': 'ペックデック (またはケーブルフライ)',
    'Plank + side plank': 'プランク + サイドプランク',
    'Power Clean': 'パワークリーン',
    'Pronated pull-ups (weighted if possible)': '懸垂 (順手、可能なら加重)',
    'Pull-up': '懸垂',
    'Rear Delt Fly': 'リアデルトフライ',
    'Reverse EZ-bar curl': 'リバースカール (EZバー)',
    'Romanian Deadlift': 'ルーマニアンデッドリフト',
    'Rowing machine': 'ローイングマシン',
    Running: 'ランニング',
    'Seated Cable Row': 'シーテッドケーブルロウ',
    'Seated cable row (close handles)': 'シーテッドケーブルロウ (ナローグリップ)',
    'Seated Calf Raise': 'シーテッドカーフレイズ',
    'Seated calf raise machine': 'シーテッドカーフレイズ (マシン)',
    'Seated dumbbell overhead press': 'シーテッドダンベルショルダープレス',
    'Seated leg curl': 'シーテッドレッグカール',
    'Single-arm dumbbell row': 'ワンハンドダンベルロウ',
    Skullcrusher: 'スカルクラッシャー',
    'Standing barbell overhead press': 'バーベルショルダープレス (スタンディング)',
    'Standing cable curl (straight bar)': 'ケーブルカール (ストレートバー)',
    'Standing Calf Raise': 'スタンディングカーフレイズ',
    'Standing calf raise (or machine)': 'スタンディングカーフレイズ (またはマシン)',
    'Straight-arm cable pulldown': 'ストレートアームプルダウン',
    'Triceps Pushdown': 'トライセプスプレスダウン',
    'Triceps pushdown (rope)': 'トライセプスプレスダウン (ロープ)',
    'Walking lunges with dumbbells': 'ウォーキングランジ (ダンベル)',

    // Alpha Progression imports used by the existing account.
    'Behind-the-Back Curls · Cable': 'ビハインドバックカール · ケーブル',
    'Bench Press with Close Grip · Barbell': 'ナローベンチプレス · バーベル',
    'Bench Press · Barbell': 'ベンチプレス · バーベル',
    'Bench Press · Dumbbells': 'ベンチプレス · ダンベル',
    'Bench Press · Smith machine': 'ベンチプレス · スミスマシン',
    'Bent-Over Rows with Reverse Grip · Barbell': 'ベントオーバーロウ (逆手) · バーベル',
    'Bulgarian Split Squats · Dumbbells': 'ブルガリアンスクワット · ダンベル',
    'Butterfly with Close Grip · Machine': 'バタフライ (ナローグリップ) · マシン',
    'Deadlifts · Barbell': 'デッドリフト · バーベル',
    'Decline Sit-Ups · Bodyweight': 'デクラインシットアップ · 自重',
    'Face Pulls with Rope · Cable': 'フェイスプル (ロープ) · ケーブル',
    'Hammer Curls · Dumbbells': 'ハンマーカール · ダンベル',
    'Hyperextensions on Roman Chair · Bodyweight': 'バックエクステンション (ローマンチェア) · 自重',
    'Incline Bench Press · Barbell': 'インクラインベンチプレス · バーベル',
    'Incline Bench Press · Dumbbells': 'インクラインベンチプレス · ダンベル',
    'Incline Flys · Dumbbells': 'インクラインフライ · ダンベル',
    'Incline Reverse Flys · Dumbbells': 'インクラインリバースフライ · ダンベル',
    'Incline Skull Crushers · EZ bar': 'インクラインスカルクラッシャー · EZバー',
    'Incline Twist Curls · Dumbbells': 'インクラインツイストカール · ダンベル',
    'Lat Pulldowns with Close Neutral Grip · Cable':
      'ラットプルダウン (ナローニュートラル) · ケーブル',
    'Lat Pulldowns with Close Overhand Grip · Cable': 'ラットプルダウン (ナロー順手) · ケーブル',
    'Lateral Raises · Dumbbells': 'サイドレイズ · ダンベル',
    'Leg Curls on Leg Extension Machine · Machine':
      'レッグカール (エクステンションマシン) · マシン',
    'Leg Extensions · Machine': 'レッグエクステンション · マシン',
    'Leg Press · Machine': 'レッグプレス · マシン',
    'Leg Raises · Bodyweight': 'レッグレイズ · 自重',
    'Lying Leg Curls · Machine': 'ライイングレッグカール · マシン',
    'One-Arm Rows · Dumbbells': 'ワンハンドロウ · ダンベル',
    'Overhead Triceps Extensions · EZ bar': 'オーバーヘッドエクステンション · EZバー',
    'Preacher Curls · EZ bar': 'プリーチャーカール · EZバー',
    'Pull-Ups with Wide Overhand Grip · Bodyweight': '懸垂 (ワイド順手) · 自重',
    'Pullovers on Bench · Dumbbells': 'プルオーバー (ベンチ) · ダンベル',
    'Pullovers with Rope · Cable': 'プルオーバー (ロープ) · ケーブル',
    'Reverse Curls · EZ bar': 'リバースカール · EZバー',
    'Romanian Deadlifts · Barbell': 'ルーマニアンデッドリフト · バーベル',
    'Romanian Deadlifts · Smith machine': 'ルーマニアンデッドリフト · スミスマシン',
    'Rows with Close Grip · Cable': 'ケーブルロウ (ナローグリップ) · ケーブル',
    'Rows with Reverse Grip · Cable': 'ケーブルロウ (逆手) · ケーブル',
    'Rows with Wide Grip · Cable': 'ケーブルロウ (ワイドグリップ) · ケーブル',
    'Rows with Wide Neutral Grip · Cable': 'ケーブルロウ (ワイドニュートラル) · ケーブル',
    'Seal Rows · Dumbbells': 'シールロウ · ダンベル',
    'Seated Calf Raises · Machine': 'シーテッドカーフレイズ · マシン',
    'Seated Shoulder Press with Close Grip · Dumbbells':
      'シーテッドショルダープレス (ナロー) · ダンベル',
    'Seated Shoulder Press · Dumbbells': 'シーテッドショルダープレス · ダンベル',
    'Shrugs · Barbell': 'シュラッグ · バーベル',
    'Skull Crushers · EZ bar': 'スカルクラッシャー · EZバー',
    'Squats with Feet Forward · Smith machine': 'スクワット (足前置き) · スミスマシン',
    'Squats · Barbell': 'スクワット · バーベル',
    'Standing Shoulder Press · Barbell': 'ショルダープレス (スタンディング) · バーベル',
    'Sumo Deadlifts · Barbell': 'スモウデッドリフト · バーベル',
    'Triceps Pushdowns with Rope · Cable': 'トライセプスプレスダウン (ロープ) · ケーブル',
    'Upright Rows · Dumbbells': 'アップライトロウ · ダンベル',
    'Upright Rows · EZ bar': 'アップライトロウ · EZバー',
  },
  fr: {
