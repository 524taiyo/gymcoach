...
// The GymCoach logo tile: white dumbbell on an indigo rounded square.
export function BrandMark({ size = 'sm', className }: BrandMarkProps) {
  return (
    <span
      aria-hidden="true"
      className={cn(
        'inline-flex shrink-0 items-center justify-center rounded-lg bg-primary text-primary-foreground shadow-[inset_0_-1px_0_rgba(0,0,0,0.15),0_1px_2px_rgba(37,40,120,0.3)]',
